...
| 項目名 | 必須 | 内容 |
| --- | --- | --- |
| Snowflake接続情報 | ✓ | Snowflakeの接続情報を選択します。<br>詳しくは[Snowflakeの接続情報](/docs/connection-configuration-snowflake)を参照ください。<br>なお、接続情報の認証方式には「キーペア認証」と「プログラムによるアクセストークン認証」のいずれも使用できます。 |
