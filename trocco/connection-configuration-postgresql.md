...
| JDBCドライバー | Yes | PostgreSQLサーバーに接続するJDBCドライバーのバージョンを選択してください。<br>ご利用のPostgreSQLのバージョンに合わせて、下記より選択できます。 <ul><li>`JDBC Driver 42.5.1 (PostgreSQL 8.2以上)`</li><li>`9.4 1205 JDBC 41 (PostgreSQL 8.2未満)`</li></ul> |
