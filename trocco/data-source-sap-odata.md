...
|転送方法|-|全データ転送|**全データ転送・差分転送 (カラム指定)・差分転送 (SAP ODP/ODQ, deltatoken指定)**のいずれかを選択します。<br>**差分転送 (SAP ODP/ODQ, deltatoken指定)**を選択した場合は、SAP ODP/ODQのデルタリンクを指定してください。デルタリンクを指定しない場合、データを最初から転送します。<br>その他の差分転送方式について、詳しくは[差分転送機能](/docs/incremental-data-transfer)を参照ください。|
