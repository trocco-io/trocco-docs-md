...
| フィールド | No | - | 取得するレポートに含めるフィールドを選択します。<br>[レポートテンプレート読み込み](/docs/data-source-facebook-ad-insights#レポートテンプレート読み込み)をクリックすることで、主要なフィールドをテンプレートから読み込むこともできます。<br>各項目の詳細については、以下のFacebook公式ドキュメントをそれぞれ参照ください。<ul><li>`account`：[Facebook公式ドキュメント - Ad Account, Insights](https://developers.facebook.com/docs/marketing-api/reference/ad-account/insights/v25.0)</li><li>`campaign`：[Facebook公式ドキュメント - Campaign Insights](https://developers.facebook.com/docs/marketing-api/reference/ad-campaign-group/insights/v25.0)</li><li>`adset`：[Facebook公式ドキュメント - Ad Set Insights](https://developers.facebook.com/docs/marketing-api/reference/ad-campaign/insights/v25.0)</li><li>`ad`：[Facebook公式ドキュメント - Ad Insights](https://developers.facebook.com/docs/marketing-api/reference/adgroup/insights/v25.0)</li></ul>TROCCOで選択できるフィールドは、Ad Insights APIで提供されるフィールドの一部です。選択肢に含まれないフィールドは取得できません。必要なフィールドが見つからない場合は、カスタマーサクセスまでお問い合わせください。 |
...
| 集計単位 | Yes | 1日単位 | データの集計単位を選択します。以下から選択可能です。<ul><li>指定期間全体：指定したデータ取得期間全体で集計されたデータを取得します。</li><li>月単位：月単位で集計されたデータを取得します。</li><li>N日単位：1〜90日の範囲で指定した日数単位で集計されたデータを取得します。</li></ul> |
